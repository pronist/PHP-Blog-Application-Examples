...
Route::add('post', '/users', '\App\Controllers\UserController::store', [ RequireMiddleware::class ]);

Route::add('get', '/posts/write', '\App\Controllers\PostController::create', [ AuthMiddleware::class ]);
Route::add('post', '/posts', '\App\Controllers\PostController::store', [ AuthMiddleware::class, CsrfTokenMiddleware::class, RequireMiddleware::class ]);
...
Route::add('patch', '/posts/{id}', '\App\Controllers\PostController::update', [ AuthMiddleware::class, CsrfTokenMiddleware::class, RequireMiddleware::class ]);
Route::add('delete', '/posts/{id}', '\App\Controllers\PostController::destroy', [ AuthMiddleware::class, CsrfTokenMiddleware::class, RequireMiddleware::class ]);
